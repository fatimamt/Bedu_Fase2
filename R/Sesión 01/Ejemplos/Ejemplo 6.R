...
# Este ejemplo elevar? al cuadrado las primeras 10 entradas de un vector generado aleat?riamente de 20 entradas
...
# De este modo estamos asignando un valor a una variable en funci?n del valor de
# otra. Lo que se debe tener en cuenta es que la condici?n debe retornar un
# valor TRUE o FALSE.