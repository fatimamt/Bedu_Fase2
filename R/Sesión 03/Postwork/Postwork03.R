...
# Equipo en casa
png(filename = "prob_marg_host.png", width = 800, height = 600)
...
# Equipo visitante
png(filename = "prob_marg_away.png", width = 800, height = 600)
...
png(filename = "heatmap_prob_conj.png", width = 800, height = 600)
