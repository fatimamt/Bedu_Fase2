...
plot(AP,
     main = "Pasajeros mensuales en una aerolínea",
     ylab = "Número de pasajeros (en miles)",
     xlab = "Mes")

# Descomposición multiplicativa
?decompose
comp <- decompose(AP, type = "multiplicative")
comp2 <- decompose(AP, type = 'additive')
comp3 <- decompose(AP)
...
plot(comp$trend,
     ...
     ylab = "Tendencia",
     xlab = "Mes")  # Gráfica de la tendencia 
...
plot(comp$seasonal,
     col = "red", 
     lwd = 2, 
     main = "Componente de estacionalidad", 
     ylab = "Estacionalidad", 
     xlab = "Mes") # Gráfica de la estacionalidad
